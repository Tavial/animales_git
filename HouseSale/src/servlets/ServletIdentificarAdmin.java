...
/**
 * Servlet implementation class ServletIdentificarAdmin
 */
@WebServlet("/ServletIdentificarAdmin")
public class ServletIdentificarAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private final static String PASS_ADMIN = "Tatiana"; 
	
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (request.getParameter("pass").contentEquals(PASS_ADMIN)) {
			// para que el filtro no intercepte más
